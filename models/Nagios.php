    ...
    public static function menuItems()
    {
        return [
            'Current Status' => [
                ...
                ['Service Problems'=>'/nagios/cgi-bin/status.cgi?host=all&amp;servicestatustypes=28&servicefilter=^[/A-TV-Za-z0-9\-]'],
                ['Updates'=>'/nagios/cgi-bin/status.cgi?host=all&amp;servicestatustypes=28&servicefilter=^U'],
